        ...
        private void btnCalcProfit_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    //attempts to adds the profits value to the end of items otherwise sends error message and haults method
                    try{    items.Add(calc_profit(items[4], items[5]));   }
                    catch{    MessageBox.Show("file is not valid, please enter a different file"); return;   }
